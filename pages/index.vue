...
// 被選取的房型
const selectedRoomInfo = ref<Room | null>(null)

// 選取要預訂的房型
function handleReservation(roomInfoData: Room) {
  selectedRoomInfo.value = roomInfoData
  resetUserForm()
}

// 建立訂單
function createOrder(roomInfo: Room | null, userInfo: UserInfo) {
  ...
  */
  ...
  bookingResult.value = _bookingResult
...
<template>
  <div class="container-fluid mt-5">
    <div class="row justify-content-center">
      ...
      <div v-if="selectedRoomInfo?._id" class="col-lg-4">
        <h3 class="mb-3">
          訂房資訊
        </h3>
        <p class="fs-1">
        ...
        <section class="mb-5">
          ...
          <form class="d-flex flex-column gap-6">
            <div class="mb-3">
              <label for="name" class="form-label fs-8 fs-md-7 fw-bold">姓名</label><input
                id="name"
            ...
            <div class="mb-3">
              <label for="phone" class="form-label fs-8 fs-md-7 fw-bold">手機號碼</label><input
                id="phone"
            ...
            <div class="mb-3">
              <label for="email" class="form-label fs-8 fs-md-7 fw-bold">電子信箱</label><input
                id="email"
